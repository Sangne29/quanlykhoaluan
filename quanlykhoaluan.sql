...
CREATE TABLE `evaluation_student` (
  ...
  `l01` varchar(255) DEFAULT NULL,
  `l02` varchar(255) DEFAULT NULL,
  `l03` varchar(255) DEFAULT NULL,
  `l04` varchar(255) DEFAULT NULL,
...
INSERT INTO `evaluation_student` (`id`, `StudentID`, `ThesisTopicID`, `l01`, `l02`, `l03`, `l04`, `registertopicID`) VALUES
(19, 28, 29, NULL, NULL, NULL, NULL, 55);
...
(55, 'Xây dựng Phần mềm hay Website Quản Lý khoá luận tốt nghiệp và thực tập doanh nghiệp.', '28', 'DHHTTT15', '19519011', 'DMT', '58', 0, 'Khóa luận tốt nghiệp.', 'Xây dựng Phần mềm hay Website Quản Lý khoá luận tốt nghiệp và thực tập doanh nghiệp.', 11, 'Trần Thị Kim Chi', 'IS', 1, 1, 0, 0, NULL, NULL, 29, NULL);
...
(58, '28', '19519011', 'DMT', 'DHHTTT15', 29, 11, 'Trần Thị Kim Chi', 58, 55);
