<?php
 ...
 class Student_group extends Database
 {
 	...
 	function __construct()
 	{
        ...
        $this->user = $this->TableName('user');
    }

    ////

    function nongroup_student_list(){
        $sql = "SELECT * from $this->user where access = 6 and $this->user.ID not in (select ID1 from $this->table)";
